...
class Sitemap {
	...
	const SCHEMA2 = 'http://www.w3.org/2001/XMLSchema-instance';
	const SCHEMA3 = 'http://www.google.com/schemas/sitemap/0.84 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd';
	const SABLON = '<?xml-stylesheet type="text/xsl" href="gss.xsl"?>';
...
$sitemaps = array("http://aklisahane.com/sitemap.xml");
...
public function SubmitSiteMap($url) {
